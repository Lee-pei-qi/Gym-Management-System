...
public class CustomerProfileEdit extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CustomerProfileEdit
     */
    public CustomerProfileEdit() throws ParseException{
        initComponents();
        ...
        dateDOB.setDate(sdf.parse(customer.getDOB()));   // parse str into date object
    }
    ...
    private void initComponents() {
        ...
        setTitle("Customer Edit Profile");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(dateDOB, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                        .addComponent(comboGender, javax.swing.GroupLayout.Alignment.LEADING, 0, 280, Short.MAX_VALUE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (txtName.getText().isEmpty() || txtIC.getText().isEmpty() || txtEmail.getText().isEmpty() || txtPhone.getText().isEmpty() || 
                txtStreet.getText().isEmpty() || txtCity.getText().isEmpty() || txtPostcode.getText().isEmpty() || txtState.getText().isEmpty() || 
                txtCountry.getText().isEmpty() || dateDOB.getDate() == null || comboGender.getSelectedItem() == null){
            ...
            try {
                ...
                wf.updateRow(user.getUsername(), 0, customer.toString());
