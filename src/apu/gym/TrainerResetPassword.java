 ...
 * @author Acer
 */
public class TrainerResetPassword extends javax.swing.JFrame {
    
    /**
     * Creates new form TrainerResetPassword
     */
    public TrainerResetPassword() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Trainer Reset Password");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrainerResetPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrainerResetPassword().setVisible(true);
            }
        });
    }
