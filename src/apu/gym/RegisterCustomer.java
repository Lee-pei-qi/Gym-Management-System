...
public class RegisterCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("APU Gym Customer Registration");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (txtName.getText().isEmpty() || txtUsername.getText().isEmpty() || txtPassword.getText().isEmpty() || txtCfmPassword.getText().isEmpty() || txtIC.getText().isEmpty() || txtEmail.getText().isEmpty() || txtPhone.getText().isEmpty() || txtStreet.getText().isEmpty() || txtCity.getText().isEmpty() || txtPostcode.getText().isEmpty() || txtState.getText().isEmpty() || txtCountry.getText().isEmpty() || dateDOB.getDate() == null || comboGender.getSelectedItem() == null){
            ...
            try {
                ...
                customer.setDOB(sdf.format(dateDOB.getDate()));   // parse date into string
                customer.setGender(comboGender.getSelectedItem().toString());

                if (Manager.registercustomer(username, name, email, password, role)){
                    JOptionPane.showMessageDialog(this, "Customer Registered!" , "Data Inserted", JOptionPane.INFORMATION_MESSAGE);
                    this.dispose();
